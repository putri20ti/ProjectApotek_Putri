            ...
            <table class="table">
                <div class="bg-secondary rounded h-100 p-4">
                    <form action="" method="POST">
                        ...
                        <div class=" form-floating mb-3">
                            <input type="satuan" name="satuan" value="<?= set_value('satuan')?>" class="form-control"
                                id="floatingInput" placeholder="Satuan Obat">
                            <label for="floatingInput">Satuan</label>
                            <?= form_error('satuan', '<small class="text-danger p1-3">', '</small>'); ?>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="harga_beli" name="harga_beli" value="<?= set_value('harga_beli')?>"
                        ...
                        <div class="form-floating mb-3">
                            <input type="harga_jual" name="harga_jual" value="<?= set_value('harga_jual')?>"
                        ...
                        <div class="form-floating mb-3">
                            <input type="jumlah_stok" name="jumlah_stok" value="<?= set_value('jumlah_stok')?>"
